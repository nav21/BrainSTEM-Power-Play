 ...
 */
@Config
@Autonomous(name="Left_V+4L", group = "auto")
public class visionLeft_4L extends BaseAuto {
...
//                .build();
        ...
        goDepositLow1 = robot.drive.trajectoryBuilder(goToFirstCone3.end())
                .lineToSplineHeading(new Pose2d(-21, d*20, Math.toRadians(d*315)), BMecanumDrive.getVelocityConstraint(40, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
        ...
        goReturnToCone1 = robot.drive.trajectoryBuilder(goDepositLow1.end())
                .lineToSplineHeading(new Pose2d(-13.5, d*7.5, Math.toRadians(d*270)), BMecanumDrive.getVelocityConstraint(40, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
        ...
        goReturnToCone3 = robot.drive.trajectoryBuilder(goDepositLow1.end())
                .lineToSplineHeading(new Pose2d(-13.5, d*7.5, Math.toRadians(d*270)), BMecanumDrive.getVelocityConstraint(40, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .addTemporalMarker(0.01, () -> robot.claw.setCurrentGoal(Claw.Goal.RESET))
                .addTemporalMarker(0.2, () -> robot.lift.setMode(Lift.Mode.CONE_2))
                .build();
...
//                .build();
        getInPositionForPark1= robot.drive.trajectoryBuilder(goDepositLow1.end()) // TODO change this end trajectoy
                .lineToSplineHeading(new Pose2d(-12.5, d*10, Math.toRadians(d*270)), BMecanumDrive.getVelocityConstraint(51, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(40))
        ...
        getInPositionForPark2 = robot.drive.trajectoryBuilder(getInPositionForPark1.end()) // TODO change this end trajectoy
                .lineToConstantHeading(new Vector2d(-60, d*10), BMecanumDrive.getVelocityConstraint(40, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        parkA = robot.drive.trajectoryBuilder(getInPositionForPark2.end())
                .lineTo(new Vector2d(-12.5, d*36), BMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(40))
                .build();

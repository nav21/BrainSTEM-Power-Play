...
@Config
@Disabled
@Autonomous(name="Left_V+5H", group = "auto")
public class visionLeft_5H extends BaseAuto {
    ...
    public void buildPaths(AutoBrainSTEMRobot robot) {
        ...
        goToMedGoalPosition = robot.drive.trajectoryBuilder(startPose,true)
                .splineToSplineHeading(new Pose2d(-42, -36, Math.toRadians(d*-270)), Math.toRadians(0), BMecanumDrive.getVelocityConstraint(40, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .splineToConstantHeading(new Vector2d(-26, -35), Math.toRadians(0), BMecanumDrive.getVelocityConstraint(40, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .splineToSplineHeading(new Pose2d(-5, -43, Math.toRadians(d*225)),Math.toRadians(-45), BMecanumDrive.getVelocityConstraint(40, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .addTemporalMarker(0.01, () -> robot.claw.setCurrentGoal(Claw.Goal.COLLECT_MID))
                .addTemporalMarker(1, () -> robot.lift.setGoal(Lift.Goal.UP))
...
//                .build();
        goToFirstCone3 = robot.drive.trajectoryBuilder(goToMedGoalPosition.end())
                .splineToSplineHeading(new Pose2d(-11.5, -27, Math.toRadians(d*270)), Math.toRadians(90), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .splineToSplineHeading(new Pose2d(-11.5, -7.5, Math.toRadians(d*270)), Math.toRadians(90), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
        ...
        goDepositConeMed = robot.drive.trajectoryBuilder(goToFirstCone3.end(), true)
                .splineToSplineHeading(new Pose2d(-11.5, -27, Math.toRadians(d*295)), Math.toRadians(-90), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .splineToSplineHeading(new Pose2d(-5, -43, Math.toRadians(d*225)), Math.toRadians(-45), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
        ...
        goReturnToCone3 = robot.drive.trajectoryBuilder(goDepositConeMed.end())
                ...
                .addTemporalMarker(0.4, () -> robot.claw.setCurrentGoal(Claw.Goal.RESET))
                .build();
        goReturnToCone4 = robot.drive.trajectoryBuilder(goDepositConeMed.end())
                .splineToSplineHeading(new Pose2d(-11.5, -27, Math.toRadians(d*270)), Math.toRadians(90), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .splineToSplineHeading(new Pose2d(-11.5, -7.5, Math.toRadians(d*270)), Math.toRadians(90), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))

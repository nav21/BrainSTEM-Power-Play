...
public class visionLeft_5M extends BaseAuto {
    ...
    public void buildPaths(AutoBrainSTEMRobot robot) {
        ...
        double d;
        double maxAccel = 60.0;   // Ludicrous speed
        // double maxAccel = DriveConstants.MAX_ACCEL;
        ...
        goToPoleMed_1 = robot.drive.trajectoryBuilder(startPose,true)
                .lineToSplineHeading(new Pose2d(-36, d*36, Math.toRadians(d*180)), BMecanumDrive.getVelocityConstraint(40, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
        ...
        goToCone5_3 = robot.drive.trajectoryBuilder(goToCone5_2.end())
                .lineToConstantHeading(new Vector2d( coneStack_X, coneStack_Y), BMecanumDrive.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
                .build();
        goToPoleLow = robot.drive.trajectoryBuilder(goToCone5_3.end(),true)
                .splineToSplineHeading(new Pose2d(-45.0, d*13.25, Math.toRadians(d*180.0)), Math.toRadians(0.0), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
                .splineToSplineHeading(new Pose2d(-29.0, d*21.8, Math.toRadians(d*225.0)), Math.toRadians(d*45.0), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
                .addTemporalMarker(0.01, () -> robot.lift.setHeight(Lift.Height.MED))
                .addTemporalMarker(0.8, () -> robot.claw.setCurrentGoal(Claw.Goal.FLIP))
                .build();
        goToCone4 = robot.drive.trajectoryBuilder(goToPoleLow.end())
                .splineToSplineHeading(new Pose2d(-45.0, d*13.25, Math.toRadians(d*180.0)), Math.toRadians(d*180.0), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
                .splineToSplineHeading(new Pose2d(coneStack_X-1.0, coneStack_Y, Math.toRadians(d*180.0)), Math.toRadians(d*180.0), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
        ...
        goToCone3 = robot.drive.trajectoryBuilder(goToPoleLow.end())
                .splineToSplineHeading(new Pose2d(-45.0, d*13.25, Math.toRadians(d*180.0)), Math.toRadians(d*180.0), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
                .splineToSplineHeading(new Pose2d(coneStack_X-2.0, coneStack_Y, Math.toRadians(d*180.0)), Math.toRadians(d*180.0), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
        ...
        goToCone2 = robot.drive.trajectoryBuilder(goToPoleLow.end())
                .splineToSplineHeading(new Pose2d(-45.0, d*13.25, Math.toRadians(d*180.0)), Math.toRadians(d*180.0), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
                .splineToSplineHeading(new Pose2d(coneStack_X-3.0, coneStack_Y, Math.toRadians(d*180.0)), Math.toRadians(d*180.0), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
        ...
        goToCone1 = robot.drive.trajectoryBuilder(goToPoleLow.end())
                .splineToSplineHeading(new Pose2d(-45.0, d*13.25, Math.toRadians(d*180.0)), Math.toRadians(d*180.0), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
                .splineToSplineHeading(new Pose2d(coneStack_X-4.0, coneStack_Y, Math.toRadians(d*180.0)), Math.toRadians(d*180.0), BMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
        ...
        getInPositionForPark_1= robot.drive.trajectoryBuilder(goToPoleLow.end()) // TODO change this end trajectoy
                .lineToSplineHeading(new Pose2d(-36, d*14, Math.toRadians(d*180)), BMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
        ...
        //                BMecanumDrive.getAccelerationConstraint(maxAccel))
        //        .build();
        parkA = robot.drive.trajectoryBuilder(getInPositionForPark_1.end())
                .lineTo(new Vector2d(-12, d*14), BMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
                .addTemporalMarker(0.5, () -> robot.lift.setGoal(Lift.Goal.DOWN))
                .addTemporalMarker(0.4, () -> robot.claw.setCurrentGoal(Claw.Goal.RESET))
                .build();
        parkB = robot.drive.trajectoryBuilder(getInPositionForPark_1.end())
                .lineTo(new Vector2d(coneStack_X, d*14), BMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(maxAccel))
                .addTemporalMarker(0.5, () -> robot.lift.setGoal(Lift.Goal.DOWN))
                .addTemporalMarker(0.4, () -> robot.claw.setCurrentGoal(Claw.Goal.RESET))
                .build();
    ...
    public void runMain(AutoBrainSTEMRobot robot, SignalSleevePosition signalSleevePosition) {
        String className = this.getClass().getSimpleName().toLowerCase();
        robot.lift.MAX_LIFT_UP_PWR = 0.75 ;

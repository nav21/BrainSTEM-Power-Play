 ...
 */
@Config
@Autonomous(name="Right_V+1Low", group = "auto")
public class visionRight_1Low extends BaseAuto {
    ...
    public void buildPaths(AutoBrainSTEMRobot robot) {
        ...
        depositPreloadLowGoal = robot.drive.trajectoryBuilder(goToMedGoalPosition.end())
                .lineTo(new Vector2d(-43, d*25), BMecanumDrive.getVelocityConstraint(10, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        BMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

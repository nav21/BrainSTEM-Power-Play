...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(40, 0, 15, 11.6);
    ...
    public static double GEAR_RATIO = 0.992; // output (wheel) speed / input (motor) speed

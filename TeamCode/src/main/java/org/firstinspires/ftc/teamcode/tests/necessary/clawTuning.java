...
public class clawTuning extends LinearOpMode {
    ...
    private double leftServoPos = 0.5 ;
    private double rightServoPos = 0.5 ;
    ...
    private void mapControls() {
        ...
        leftServoPos = leftServoResetStickyButton.getState() ? 0.5 : leftServoPos;
        ...
        rightServoPos = rightServoResetStickyButton.getState() ? 0.5 : rightServoPos;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested()) {
            ...
            claw.setLeftClawPosition(leftServoPos);
            claw.setRightClawPosition(rightServoPos);
